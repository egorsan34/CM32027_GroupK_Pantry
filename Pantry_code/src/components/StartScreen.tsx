      ...
      <div style={{ width: '100%', padding: '0 48px' }}>
        <div className="flex justify-center mb-8">
          <img
            ...
            alt="Pantry"
            style={{ height: '120px', width: 'auto', filter: 'brightness(0)' }}
          />
        </div>
        ...
        <form onSubmit={handleAuth} className="space-y-4">
          <div>
            ...
            <input 
              ...
              className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:border-[#4CAF50] focus:outline-none text-gray-800 bg-white"
          ...
          <button 
            type="submit"
            disabled={loading}
            className="w-full bg-[#4CAF50] text-white py-3 rounded-xl font-semibold mt-2 disabled:opacity-50"
          >
